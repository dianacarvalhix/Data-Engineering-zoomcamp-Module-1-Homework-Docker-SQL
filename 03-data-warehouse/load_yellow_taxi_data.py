...
BUCKET_NAME = "kestra-zoomcamp-496118"
...
# Load env file
load_dotenv(".env_encoded")

# Get encoded service account
encoded_sa = os.environ["SECRET_GCP_SERVICE_ACCOUNT"]

# Decode base64 -> JSON string
decoded_sa = base64.b64decode(encoded_sa).decode("utf-8")

# Parse JSON
service_account_info = json.loads(decoded_sa)
